					...
					<main id="contentbar">
						<div class="article">
									<div align="center">
										...
										<c:choose>
										<c:when test= "${diamond.isInStock == true}">
										...
										<td>
										<a href="${contextPath}/addCart?id=${diamond.id}">add to cart</a>
										</td>
										</tr>
										</table>
										</c:when>
										<c:otherwise>No Longer Available</c:otherwise>
										</c:choose>
										...
										<table border="0" width=400px>
											...
											<tr>
											<td>Stock Number</td><td>${diamond.stockItem}</td>
											</tr>
											<tr>
											<td>Carat Weight</td><td>${diamond.carat}</td>
											</tr>
											<tr>
											<td>Shape</td><td>${diamond.shape}</td>
											</tr>
											<tr>
											<td>Cut</td><td>${diamond.cut}</td>
											</tr>
											<tr>
											<td>Color</td><td>${diamond.color}</td>
											</tr>
											<tr>
											<td>Clarity</td><td>${diamond.clarity}</td>
											</tr>
											<tr>
											<td>Polish</td><td>${diamond.polish}</td>
											</tr>
											<tr>
											<td>Symmetry</td><td>${diamond.symmetry}</td>
											</tr>
											<tr>
											<td>Girdle</td><td>${diamond.girdle}</td>
											</tr>
											<tr>
											<td>Cutlet</td><td>${diamond.cutlet}</td>
											</tr>
											<tr>
											<td>Fluorescence</td><td>${diamond.fluorescence}</td>
											</tr>
											<tr>
											<td>Certificate Number</td><td><a href="http://igiworldwide.com/verify.php?r=${diamond.certificateId}">${diamond.certificateId}</a></td>
											</tr>
										</table>
										</td>
										</table>

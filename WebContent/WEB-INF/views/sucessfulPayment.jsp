			...
			<div id="content">
				<div id="content-inner">
					...
					<main id="contentbar">
						...
						<li><a href="${contextPath}/invoice?id=${paypalInformation.cartId}">Printable Invoice</a></li>
 						Order Details: #${paypalInformation.cartId}<br/>
						Order Date: ${paypalInformation.date}<br/>
						Shipping Address: <br/>
						${paypalInformation.userShippingAddress}<br/><hr/> 
